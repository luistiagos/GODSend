...
[![GODsend 360 v2.9.2 overview video preview](docs/site/assets/GODsend-360-2.9.2-preview.png)](docs/site/assets/GODsend-360-2.9.2.mov)

[Download or play the overview video (`.mov`)](docs/site/assets/GODsend-360-2.9.2.mov)
...
|---|---|---|
| **Windows (x64, installer — tray app + backend)** | [`xbox-360-companion-Setup-2.12.40-x64.exe`](https://gofile.io/d/37IXmG) | [`xbox-360-companion-Setup-2.12.40-x64.exe`](https://file.kiwi/7c60592b#rqB5pynFvj09UP-iES_prg) |
| **Windows (x64, portable — no install needed)** | [`xbox-360-companion-Portable-2.12.40.exe`](https://gofile.io/d/pnHMrf) | [`xbox-360-companion-Portable-2.12.40.exe`](https://file.kiwi/bb5fbb75#AlchyU1d0FCQGSGoOIRzMQ) |
| **Windows (ia32 / 32-bit, portable)** | [`xbox-360-companion-Portable-2.12.40-ia32.exe`](https://gofile.io/d/pnHMrf) | [`xbox-360-companion-Portable-2.12.40-ia32.exe`](https://file.kiwi/bb5fbb75#AlchyU1d0FCQGSGoOIRzMQ) |
| **macOS (Apple Silicon)** | [`xbox-360-companion-2.12.40-arm64.dmg`](https://gofile.io/d/x3Ig2y) | [`xbox-360-companion-2.12.40-arm64.dmg`](https://file.kiwi/39bfadea#xDm2KTFizR2KTdqYtzk02g) |
| **macOS (Intel)** | [`xbox-360-companion-2.12.40-x64.dmg`](https://gofile.io/d/o5UeTH) | [`xbox-360-companion-2.12.40-x64.dmg`](https://file.kiwi/9b476035#8bCXdyItt8yLauNew6Lr7g) |
| **Linux (x64 / amd64)** | [`xbox-360-companion-2.12.40-x64.AppImage`](https://gofile.io/d/dq3TW6) | [`xbox-360-companion-2.12.40-x64.AppImage`](https://file.kiwi/f33d9e80#t2xnWyVG7D4l_Yx3sRiYyA) |
| **Linux (arm64)** | [`xbox-360-companion-2.12.40-arm64.AppImage`](https://gofile.io/d/2EAscX) | [`xbox-360-companion-2.12.40-arm64.AppImage`](https://file.kiwi/00620d8b#vR2T0H26NrCEv-rybSqNSQ) |
...
1. **macOS:** open the `.dmg` and drag **Xbox 360 Companion** to Applications. **Linux:** `chmod +x` the `.AppImage` and run it. **Windows:** run **`xbox-360-companion-Setup-2.12.40-x64.exe`** and follow the installer (or just run **`xbox-360-companion-Portable-2.12.40.exe`** directly — no install step needed).
...
| **macOS (universal, Electron helper)** | [`godsend-mac`](https://gofile.io/d/lX7rHS) | [`godsend-mac`](https://file.kiwi/1fb35db5#J7TswfCJ87COlOizmSs-Fw) |
| **Linux (x64)** | [`godsend-linux-x64`](https://gofile.io/d/e0FCcx) | [`godsend-linux-x64`](https://file.kiwi/6aeaf6c0#cinl7EF5J8hSPRvSXj-gFA) |
