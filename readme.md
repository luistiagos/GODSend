...
|---|---|---|
| **Windows (x64, installer — tray app + backend)** | [`godsend-Setup-2.12.26.exe`](https://gofile.io/d/37IXmG) | [`godsend-Setup-2.12.26.exe`](https://file.kiwi/7c60592b#rqB5pynFvj09UP-iES_prg) |
| **Windows (x64, portable — no install needed)** | [`godsend-Portable-2.12.26.exe`](https://gofile.io/d/pnHMrf) | [`godsend-Portable-2.12.26.exe`](https://file.kiwi/bb5fbb75#AlchyU1d0FCQGSGoOIRzMQ) |
| **macOS (Apple Silicon)** | [`godsend-2.12.26-arm64.dmg`](https://gofile.io/d/x3Ig2y) | [`godsend-2.12.26-arm64.dmg`](https://file.kiwi/39bfadea#xDm2KTFizR2KTdqYtzk02g) |
| **macOS (Intel)** | [`godsend-2.12.26-x64.dmg`](https://gofile.io/d/o5UeTH) | [`godsend-2.12.26-x64.dmg`](https://file.kiwi/9b476035#8bCXdyItt8yLauNew6Lr7g) |
| **Linux (x64 / amd64)** | [`godsend-2.12.26-x86_64.AppImage`](https://gofile.io/d/dq3TW6) | [`godsend-2.12.26-x86_64.AppImage`](https://file.kiwi/f33d9e80#t2xnWyVG7D4l_Yx3sRiYyA) |
| **Linux (arm64)** | [`godsend-2.12.26-arm64.AppImage`](https://gofile.io/d/2EAscX) | [`godsend-2.12.26-arm64.AppImage`](https://file.kiwi/00620d8b#vR2T0H26NrCEv-rybSqNSQ) |
...
1. **macOS:** open the `.dmg` and drag **GODsend** to Applications. **Linux:** `chmod +x` the `.AppImage` and run it. **Windows:** run **`godsend-Setup-2.12.26.exe`** and follow the installer (or just run **`godsend-Portable-2.12.26.exe`** directly — no install step needed).
