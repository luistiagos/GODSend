...
Go to the [GODsend 360 v2.2.5 release](https://gitgud.io/ghosty99/godsend-360/-/releases/v2.2.5) and download:

- **[`godsend-Setup-2.2.5.exe`](https://gitgud.io/api/v4/projects/ghosty99%2Fgodsend-360/packages/generic/installer/2.2.5/godsend-Setup-2.2.5.exe)** — Windows installer for the Electron tray app + backend (Aurora scripts are bundled)

### 2. Install the Electron app

1. Run `godsend-Setup-2.2.5.exe` and follow the installer prompts.
