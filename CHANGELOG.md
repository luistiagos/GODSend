...
- **O Defender barrava a formatacao antes de ela comecar: "Alteracoes nao autorizadas bloqueadas ... impediu \Device...\fat32format.exe de fazer alteracoes na memoria" (`fat32Format.ts`, `fat32FormatGuard.test.cjs`) - v2.12.89**:
  ...
  - **Nada e desligado globalmente e nada preexistente e removido.** `Set-MpPreference` nao e chamado em lugar nenhum: a protecao continua ligada e so o nosso executavel e excecionado. A retirada e condicionada a `$script:cfaAllowlistAdded`, entao uma liberacao que o proprio usuario tenha feito antes sobrevive.
